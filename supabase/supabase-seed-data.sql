...
-- Insert Models
insert into models (id, area_id, name, slug, image, images, short_description, description, price, features, specifications) values
  ('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa',
   ...
   'The Alpha Pro is our flagship offering, featuring cutting-edge technology and premium build quality. It comes with comprehensive support and a wide range of customization options to suit your needs.',
   '₹15,00,000',
  ...
  ('ffffffff-ffff-ffff-ffff-ffffffffffff', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa',
   ...
   'The Beta Standard offers excellent value with reliable performance and quality build. Perfect for everyday use with all essential features included.',
   '₹8,50,000',
